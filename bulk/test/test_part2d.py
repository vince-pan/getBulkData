...
class TestPart2D(TestCase):
    def setUp(self):
        ...
        self.part_2d = Part2D(part_2d_id, {elm.eid: elm for elm in self.model.elements.values() if elm.eid in eids})


class TestGetNodes(TestPart2D):
    def test_is_nodes_list(self):
        self.assertIsInstance(self.part_2d.nodes, list)
